...
# Read generated data
{
  ...
  # Anacostia River
  anr <- read.csv("Output/Data/Sites/csv/AnacostiaRiver/AnacostiaRiverRFObsPredtPCBV02.csv")
  ...
  por <- read.csv("Output/Data/Sites/csv/PortlandHarbor/PortlandHarborRFObsPredtPCBV02.csv")
  # Richardson Hill Road Landfill
  rhr <- read.csv("Output/Data/Sites/csv/Richardson/RichardsonRFObsPredtPCB.csv")
  # Spokane River data
  spo <- read.csv("Output/Data/Sites/csv/SpokaneRiver/SpokaneRiverRFObsPredtPCBV02.csv")
