...
# Export results
write.csv(lme.pcb, file = "Output/Data/Sites/csv/FoxRiver/Quadratic/FoxRiverLmeQuadPCB.csv",
          row.names = FALSE)
...
ggsave("Output/Plots/Sites/ObsPred/FoxRiver/Quadratic/LmeQuadCombined_plot.png", plot = combined_plot,
...
write.csv(combined_cleaned_df,
          file = "Output/Data/Sites/csv/FoxRiver/Quadratic/FoxRiverLmeQuadObsPredPCB.csv",
          row.names = FALSE)
